...
use sonvq\Cassandra\Relations\BelongsTo;
use sonvq\Cassandra\Relations\BelongsToMany;
use sonvq\Cassandra\Relations\HasMany;
use sonvq\Cassandra\Relations\HasOne;
use sonvq\Cassandra\Relations\MorphTo;
