...
use sonvq\Cassandra\Query\Builder as QueryBuilder;
use sonvq\Cassandra\Relations\EmbedsMany;
use sonvq\Cassandra\Relations\EmbedsOne;
use sonvq\Cassandra\Relations\EmbedsOneOrMany;
